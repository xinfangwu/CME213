...
// but not exit program in case an error is detected.
...
inline bool checkCmdLineFlag(const int argc, char **argv,
...
template <class T>
inline bool getCmdLineArgumentValue(const int argc, char **argv,
...
inline int getCmdLineArgumentInt(const int argc, char **argv,
                                 const char *string_ref)
{
  bool bFound = false;
  int value = -1;
...
inline float getCmdLineArgumentFloat(const int argc, char **argv,
                                     const char *string_ref)
{
  bool bFound = false;
  float value = -1;
...
inline bool getCmdLineArgumentString(const int argc, char **argv,
                                     const char *string_ref,
                                     char **string_retval)
{
  bool bFound = false;
